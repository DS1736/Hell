...
{
    internal class BarcodeHandle : VectorFigure, IHandle
    {
        private readonly Shapes.Basic.Barcode _barcode;
        public VectorFigure HandleShape { get; set; }

        public Figure Owner { get; }

        public BarcodeHandle(VectorFigure handleShape, Shapes.Basic.Barcode barcode)
        {
            _barcode = barcode;
            Owner = barcode;
        ...
        public void Update()
        {
            ForceSetPositionOfCenter(_barcode.X, _barcode.Y);
            HandleShape.ForceSetPositionOfCenter(_barcode.X, _barcode.Y);
        }
