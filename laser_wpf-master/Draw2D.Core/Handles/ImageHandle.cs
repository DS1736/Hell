...
{
    internal class ImageHandle : VectorFigure, IHandle
    {
        private readonly Shapes.Basic.Image _image;
        public VectorFigure HandleShape { get; set; }

        public Figure Owner { get; }

        public ImageHandle(VectorFigure handleShape, Shapes.Basic.Image image)
        {
            _image = image;
            Owner = image;
        ...
        public void Update()
        {
            ForceSetPositionOfCenter(_image.X, _image.Y);
            HandleShape.ForceSetPositionOfCenter(_image.X, _image.Y);
        }
